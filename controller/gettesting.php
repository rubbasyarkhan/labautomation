...
if(isset($_GET["search"])){
    ...
    $qry = "SELECT assigntests. * , products.name as pname , products.pcode as pcode , tests.name as tname FROM `assigntests` INNER join products on assigntests.pid = products.id INNER JOIN tests on tests.id = assigntests.tid ";
